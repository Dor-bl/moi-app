...
- **Interactive Groningen Map View 🗺️**: Switch seamlessly between List View and Map View. Features interactive map pins for all 23 locations across Groningen with real-time status (Green for completed, Orange for pending).
...
- **23 Curated Groningen Bucket List Items**: Handpicked experiences spanning Food & Drink, Culture & Sights, Daily Life, and Groningen Classics.
