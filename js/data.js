...
const UI_TRANSLATIONS = {
    en: {
        ...
        signIn: 'Sign In',
        signOut: 'Sign Out',
        signOutFailed: 'Signing out did not work on this device: its saved sign-in could be neither removed nor marked as signed out. You are still signed in here. Please try again.',
        ...
        deleteUnconfirmed: 'The server no longer accepts this browser\'s sign-in for your account, which is what happens once an account has been deleted, but we could not confirm from here that the deletion went through. You have been signed out here. If you can still sign in, the deletion is completed then. To be certain either way, email us via the Privacy Policy page and we will check.',
        deleteUnconfirmedLocalPending: 'The server no longer accepts this browser\'s sign-in for your account, which is what happens once an account has been deleted, but we could not confirm from here that the deletion went through. You have been signed out here. This browser could not clear the progress saved on it, though: clear this site\'s data in your browser settings to remove it. If you can still sign in, the deletion is completed then. To be certain either way, email us via the Privacy Policy page and we will check.',
        deleteLocalDeferred: 'This browser has not yet cleared the progress saved on it; it will the next time you open it (reload the page to do it right away).',
    ...
    nl: {
        ...
        signIn: 'Inloggen',
        signOut: 'Uitloggen',
        signOutFailed: 'Uitloggen is op dit apparaat niet gelukt: de opgeslagen aanmelding kon niet worden verwijderd of als uitgelogd gemarkeerd. Je bent hier nog ingelogd. Probeer het opnieuw.',
        ...
        deleteUnconfirmed: 'De server accepteert de aanmelding van deze browser voor je account niet meer, wat gebeurt zodra een account is verwijderd, maar we konden vanaf hier niet bevestigen dat het verwijderen is gelukt. Je bent hier uitgelogd. Kun je nog inloggen, dan wordt het verwijderen op dat moment afgemaakt. Wil je zekerheid, mail ons dan via de privacybeleid-pagina en wij controleren het.',
        deleteUnconfirmedLocalPending: 'De server accepteert de aanmelding van deze browser voor je account niet meer, wat gebeurt zodra een account is verwijderd, maar we konden vanaf hier niet bevestigen dat het verwijderen is gelukt. Je bent hier uitgelogd. Deze browser kon de hier opgeslagen voortgang echter niet wissen: verwijder de sitegegevens van deze site in je browserinstellingen om die weg te halen. Kun je nog inloggen, dan wordt het verwijderen op dat moment afgemaakt. Wil je zekerheid, mail ons dan via de privacybeleid-pagina en wij controleren het.',
        deleteLocalDeferred: 'Deze browser heeft de hier opgeslagen voortgang nog niet gewist; dat gebeurt de volgende keer dat je hem opent (herlaad de pagina om het meteen te doen).',
